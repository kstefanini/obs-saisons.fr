...
function filterCriteria() {
    let typeSpeciesId = $('#type-species > option:selected').val();
    ...
    let $selectedSpecies = $('#species > option:selected');
    let speciesId = $selectedSpecies.val();
    ...
    if (speciesId > 0) {
        let eventsIds = (''+$selectedSpecies.data('eventsIds')).split(', ');
        $('#events option:not(.default-criteria)').each(function () {
